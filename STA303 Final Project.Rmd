...
- In the first hiring phase assessed by AI, the proportion of applicants who got approved to next phase was approximately evenly split between male and female.
...
The proportions of applicants who got accepted in phase 1 had similar proportion between male and female. We can see 25% of difference in the accepted rate in phase 1 for those who preferred not to say their gender, so we investigated them in more details using a model.
Remind that this is proportion depends on the number of the applicants and that we only had 11 applicants (2% of the entire applicants) who preferred not to say about their gender. 

In phase 2, the proportion of male applicants was slightly higher than that of female applicants. However, since only a small proportion(7%) of the applicants were accepted in the phase 2, we had become more cautious when we interpreted the difference. 
...
From confidence interval, we could see that the coefficients of gender contained 0. Therefore, we concluded that interviewers were not biased with gender. In other words, gender did not affect interview scores.

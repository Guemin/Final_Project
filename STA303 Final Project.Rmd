...
## Background & Aim
The report was conducted by KoCad for the STA 303 project to investigate the potential bias in the hiring and remuneration processes at the Black Saber Software company.
Focusing on three different sectors, we have evaluated whether salary levels were fair and not influenced by one’s gender. We then addressed the fairness in how many times a person got promoted through investigating the relationship between factors related to the employee’s talent and their respective promotion frequency. Lastly, we explored whether the hiring process using trialing AI was fair and whether the interviewer rated job applicants based on their talents.
